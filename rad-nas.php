...
// RADIUS Restart 메뉴 항목 추가
$descriptors1[] = array( 'type' => 'link', 'label' => 'RADIUS Restart',
                         'href' => "javascript:if(confirm('RADIUS 데몬을 재시작하시겠습니까?')) document.forms['restart_radius_form'].submit();", 
                         'icon' => 'arrow-repeat', );
...
<!-- RADIUS 재시작용 Hidden Form -->
<div style="display:none;">
    <form name="restart_radius_form" action="mng-rad-nas.php" method="post">
        <input type="hidden" name="restart_radius" value="1" />
    </form>
</div>
